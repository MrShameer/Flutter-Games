...
import 'package:flutter_games/snake/game.dart';
import 'package:flutter_games/solitaire/game_screen.dart';
import 'package:flutter_games/tic/pages/start.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: RaisedButton(
                  onPressed: () => {
                    if(widget.game.play == "snake"){
                      Navigator.push(
                        context,
                        MaterialPageRoute<void>(builder: (context) => GamePage()),
                      ),
                    }
                    else if(widget.game.play == "soli"){
                      Navigator.push(
                        context,
                        MaterialPageRoute<void>(builder: (context) => GameScreen()),
                      ),
                    }
                    else if(widget.game.play == "tic"){
                        Navigator.push(
                          context,
                          MaterialPageRoute<void>(builder: (context) => StartPage()),
                        ),
                      }
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        widget.game.play != null ? "Play" : "Rent",
