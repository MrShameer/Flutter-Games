...
import 'package:flutter_games/tic/components/board.dart';
...
class GamePage extends StatefulWidget {
  final String num;
  GamePage(this.num, {Key key}): super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
              title: Text(widget.num == "single" ? "Tic Tac Toe : Single Player" : "Tic Tac Toe : Multiplayer"),
